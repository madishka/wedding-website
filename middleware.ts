...
export function middleware(req: NextRequest) {
  ...
  // real token needed — see components/PreviewSite.tsx; it renders the
  // same composition as /i/[token]. The page 404s itself outside
  // development; this just keeps the gate from redirecting it away
